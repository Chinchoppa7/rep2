...
sort_button = tk.Button(root, text="Сортировать", font=('Arial, 14'),relief='ridge',bd=0, bg='blue',fg='white',activeforeground='white',activebackground='#ffb53d',  command=sort_words)
